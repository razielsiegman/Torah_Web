...
<div class='puremag-posts-content'>
    ...
    <?php
        ...
        $puremag_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'puremag' ), convert_smilies( ':)' ) ) . '</p>';
        the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$puremag_archive_content" );
    ?>
