...
function puremag_post_options($wp_customize) {
    ...
    $wp_customize->add_control( 'puremag_post_style_control', array( 'label' => esc_html__( 'Non-Singular Posts Style', 'puremag' ), 'description' => esc_html__('Select the post style you want for home/categories/tags/archive/search-results pages.', 'puremag'), 'section' => 'sc_puremag_posts', 'settings' => 'puremag_options[post_style]', 'type' => 'select', 'choices' => array( 'list' => esc_html__('List', 'puremag'), 'full' => esc_html__('Full', 'puremag') ) ) );
    ...
    $wp_customize->add_control( 'puremag_read_more_length_control', array( 'label' => esc_html__( 'Auto Post Summary Length', 'puremag' ), 'description' => esc_html__('Enter the number of words need to display in the post summary. Default is 25 words.', 'puremag'), 'section' => 'sc_puremag_posts', 'settings' => 'puremag_options[read_more_length]', 'type' => 'text' ) );
