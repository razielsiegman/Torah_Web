...
<div id="post-<?php the_ID(); ?>" class="puremag-full-post">
    ...
    <div class="puremag-full-post-thumbnail">
        <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo esc_attr( /* translators: %s: post title */ sprintf( __( 'Permanent Link to %s', 'puremag' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="puremag-full-post-thumbnail-link"><?php the_post_thumbnail('puremag-featured-image', array('class' => 'puremag-full-post-thumbnail-img')); ?></a>
    </div>
    <?php } ?>
    <?php } ?>
    ...
    wp_link_pages( array(
     'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'puremag' ) . '</span>',
     'after'       => '</div>',
     'link_before' => '<span>',
     'link_after'  => '</span>',
     'separator'   => '',
